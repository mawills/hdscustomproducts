...
<div class="container">
  ...
  <div class="row">
    ...
    <form method="POST" >
      <input type="submit" onclick="deleteProduct()" name="delete-button" value="Delete Product" />
      <input type="button" onclick="saveNewProduct()" name="save-button" value="Save Design" />
      <input type="submit" onclick="submitCanvas()" name="submit-button" value="Submit" />
    </form>
